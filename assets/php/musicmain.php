...
$message = "Dear Brian," . "\r\n" . 
$_POST["fname"] . " " . $_POST["lname"] . " has indicated an interest in the St. Ignatius music ministry." . "\r\n" .
"Has sung in a choir before?" . " " . $_POST["1yesno"] . "\r\n" . 
"Can read music?" . " " . $_POST["2yesno"] . "\r\n" . 
"Plays a musical instrument?" . " " . $_POST ["3yesno"] . "\r\n" . 
"Can attend weekly choir practices?" . " " . $_POST["4yesno"] . "\r\n" . 
"They are interested in " . " " . $_POST["ministrytype"] . "\r\n" . 
"They are also interested in " . " " . $_POST["otherinterest"] . "\r\n" . 
...
// Send
mail('music@stignatiuschurch.org', 'Music Ministry Interest Inquiry from the Website', $message);
?>
